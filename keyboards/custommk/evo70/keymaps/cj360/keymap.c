...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		KC_F1,  KC_F2,    LT(1,KC_CAPS),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,           KC_HOME,
	    KC_F3,  KC_F4,	  KC_LSFT,        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_DEL),   KC_UP,   KC_END,
		KC_F5,  KC_F6,    KC_LCTL,        KC_LWIN, KC_LALT,                   KC_SPACE,  KC_MUTE,                            KC_RCTL, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT
    ),
	...
	[1] = LAYOUT(
		...
		KC_F11, KC_F12,   KC_TRNS, KC_TRNS,          KC_TRNS,                     KC_TRNS,  KC_MPLY,                   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    )
};
