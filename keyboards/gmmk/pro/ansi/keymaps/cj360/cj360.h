/* Copyright 2021 Mikael Manukyan <arm.localhost@gmail.com>, Andrew Yunker
 *
...
enum layout_names {
    BASE = 0,  // Base Layout: The main keyboard layout that has all the characters
...
#define FN_CAPS LT(FUNCTIONS, KC_CAPS)
