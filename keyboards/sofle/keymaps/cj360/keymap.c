 ...
 */
  ...
  RGB_TOG, RGB_HUI,RGB_SAI, RGB_VAI, _______,_______,             C(G(KC_LEFT)),_______,_______,C(G(KC_RGHT)),_______, _______,
  RGB_MOD, RGB_HUD,RGB_SAD, RGB_VAD, _______,KC_QWERTY,_______,   _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______,
                  _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______
),

/* SWITCH
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | qwer | low  |raise | adj  |numpd |      |                    |      |  F7  |  F8  |  F9  | F10  | F11  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |  `   |      |      |      |      |      |                    |      |   7  |   8  |   9  |   *  | F12  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | trans|      |      |      |      |      |-------.    ,-------|   -  |   4  |   5  |   6  |      |   |  |
...
[_SWITCH] = LAYOUT(
  ...
  TO(0),   TO(1),   TO(2),   TO(3),   TO(4),   _______, 				          _______, _______, _______, _______, _______, QK_BOOT,
  _______, _______, KC_BRIU, _______, _______, _______, 				          _______, _______, _______, _______, _______, EE_CLR,
  _______, _______, KC_BRID, _______, _______, _______, _______,	    _______,  _______, _______, _______, _______, _______, _______,
                    _______, _______, _______, _______, _______,        _______,  _______, _______, _______, _______
